...
exports.TaggedCBOR = exports.SignedMessageKind = exports.SignedMessage = exports.SigStructure = exports.SigContext = exports.PubKeyEncryption = exports.ProtectedHeaderMap = exports.PasswordEncryption = exports.Labels = exports.LabelKind = exports.Label = exports.KeyType = exports.KeyOperation = exports.Int = exports.Headers = exports.HeaderMap = exports.EdDSA25519Key = exports.ECKey = exports.CurveType = exports.CounterSignature = exports.COSESignatures = exports.COSESignature = exports.COSESignBuilder = exports.COSESign1Builder = exports.COSESign1 = exports.COSESign = exports.COSERecipients = exports.COSERecipient = exports.COSEKey = exports.COSEEncrypt0 = exports.COSEEncrypt = exports.CBORValueKind = exports.CBORValue = exports.CBORSpecialType = exports.CBORSpecial = exports.CBORObject = exports.CBORArray = exports.BigNum = exports.AlgorithmId = void 0;
...
const encodeString = function encodeString(arg, view) {
...
/** */
const AlgorithmId = exports.AlgorithmId = Object.freeze({
  /**
...
/** */
const ECKey = exports.ECKey = Object.freeze({
  CRV: 0,
  "0": "CRV",
  X: 1,
  "1": "X",
...
/** */
const CurveType = exports.CurveType = Object.freeze({
  P256: 0,
  "0": "P256",
  P384: 1,
  "1": "P384",
...
/** */
const KeyOperation = exports.KeyOperation = Object.freeze({
  Sign: 0,
  "0": "Sign",
  Verify: 1,
  "1": "Verify",
...
/** */
const CBORSpecialType = exports.CBORSpecialType = Object.freeze({
  Bool: 0,
  "0": "Bool",
  Float: 1,
  "1": "Float",
...
/** */
const CBORValueKind = exports.CBORValueKind = Object.freeze({
  Int: 0,
  "0": "Int",
  Bytes: 1,
  "1": "Bytes",
...
/** */
const LabelKind = exports.LabelKind = Object.freeze({
  Int: 0,
  "0": "Int",
  Text: 1,
  "1": "Text"
...
/** */
const SignedMessageKind = exports.SignedMessageKind = Object.freeze({
  COSESIGN: 0,
  "0": "COSESIGN",
  COSESIGN1: 1,
  "1": "COSESIGN1"
...
/** */
const SigContext = exports.SigContext = Object.freeze({
  Signature: 0,
  "0": "Signature",
  Signature1: 1,
  "1": "Signature1",
...
exports.CBORSpecial = CBORSpecial;
...
exports.COSEEncrypt = COSEEncrypt;
...
exports.COSEEncrypt0 = COSEEncrypt0;
...
exports.COSERecipient = COSERecipient;
...
exports.COSERecipients = COSERecipients;
...
exports.COSESign1Builder = COSESign1Builder;
...
exports.COSESignBuilder = COSESignBuilder;
...
exports.COSESignature = COSESignature;
...
exports.COSESignatures = COSESignatures;
...
exports.EdDSA25519Key = EdDSA25519Key;
...
exports.ProtectedHeaderMap = ProtectedHeaderMap;
...
exports.PubKeyEncryption = PubKeyEncryption;
...
exports.SigStructure = SigStructure;
...
exports.TaggedCBOR = TaggedCBOR;
const imports = {
  __wbindgen_placeholder__: {
    __wbindgen_object_drop_ref: function __wbindgen_object_drop_ref(arg0) {
      takeObject(arg0);
    },
    __wbindgen_string_new: function __wbindgen_string_new(arg0, arg1) {
      const ret = getStringFromWasm0(arg0, arg1);
      return addHeapObject(ret);
    },
    __wbindgen_debug_string: function __wbindgen_debug_string(arg0, arg1) {
...
function instantiateWithInstance(opts) {
  ...
  if (lastLoadPromise == null) {
    lastLoadPromise = (async () => {
      try {
        const instance = (await instantiateModule(opts !== null && opts !== void 0 ? opts : {})).instance;
...
async function instantiateModule(opts) {
  ...
  const wasmUrl = import.meta.url.includes("_frsh") ? opts.url : new URL("cardano_message_signing_bg.wasm", import.meta.url);
  const decompress = opts.decompress;
  const isFile = wasmUrl.protocol === "file:";
  // make file urls work in Node via dnt
  const isNode = ((_globalThis$process = globalThis.process) === null || _globalThis$process === void 0 || (_globalThis$process = _globalThis$process.versions) === null || _globalThis$process === void 0 ? void 0 : _globalThis$process.node) != null;
  if (isNode && isFile) {
  ...
  switch (wasmUrl.protocol) {
    ...
    case "http:":
      {
        ...
        if (isFile || (_wasmResponse$headers = wasmResponse.headers.get("content-type")) !== null && _wasmResponse$headers !== void 0 && _wasmResponse$headers.toLowerCase().startsWith("application/wasm")) {
    ...
    default:
      throw new Error("Unsupported protocol: ".concat(wasmUrl.protocol));
  }
}