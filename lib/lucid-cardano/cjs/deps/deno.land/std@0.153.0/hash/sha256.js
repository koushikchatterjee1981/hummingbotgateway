...
exports.Sha256 = exports.HmacSha256 = void 0;
...
class Sha256 {
  constructor() {
    let is224 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
    let sharedMemory = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
class HmacSha256 extends Sha256 {
  constructor(secretKey) {
    let is224 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    let sharedMemory = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
