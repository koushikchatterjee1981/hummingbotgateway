...
describe("WithdrawConfig class", () => {
    ...
    it("should throw an error if a pool isn't set", () => {
        config.setSuppliedLPAsset(new AssetAmount(20n, { assetId: "tINDY", decimals: 6 }));
        try {
            config.buildArgs();
        }
        catch (e) {
    ...
    it("should throw when providing invalid assetIDs to setSuppliedLPAsset()", () => {
        config
            ...
            .setSuppliedLPAsset(new AssetAmount(20n, { assetId: "tINDY", decimals: 6 }));
        try {
            config.buildArgs();
        }
        catch (e) {
        ...
        config
            ...
            .setPool(PREVIEW_DATA.pools.v1)
            .setSuppliedLPAsset(new AssetAmount(20n, {
