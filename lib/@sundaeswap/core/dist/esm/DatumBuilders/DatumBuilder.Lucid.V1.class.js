 ...
 */
export class DatumBuilderLucidV1 {
    ...
    buildOrderAddresses(addresses) {
        ...
        const destination = LucidHelper.getAddressHashes(DestinationAddress.address);
        const destinationDatum = new Constr(0, [
            new Constr(0, [
                new Constr(LucidHelper.isScriptAddress(DestinationAddress.address) ? 1 : 0, [destination.paymentCredentials]),
                destination?.stakeCredentials
                    ? new Constr(0, [
                        new Constr(0, [
                            new Constr(LucidHelper.isScriptAddress(DestinationAddress.address)
                                ? 1
        ...
        const alternate = AlternateAddress && LucidHelper.getAddressHashes(AlternateAddress);
        const alternateDatum = new Constr(alternate ? 0 : 1, alternate
