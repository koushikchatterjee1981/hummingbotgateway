...
describe("DatumBuilderLucid.buildOrderAddressesDatum", () => {
    ...
    it("should correctly build and valid a pool ident", () => {
        expect(() => builderInstance.buildPoolIdent(PREVIEW_DATA.pools.v3.ident)).toThrowError(DatumBuilderLucidV1.INVALID_POOL_IDENT);
        const validIdent = builderInstance.buildPoolIdent(PREVIEW_DATA.pools.v1.ident);
