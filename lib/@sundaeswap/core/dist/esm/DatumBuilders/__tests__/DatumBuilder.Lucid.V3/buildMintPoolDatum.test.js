...
const defaultArgs = {
    ...
    seedUtxo: {
        ...
        assets: {
            lovelace: 3679167n,
            fa3eff2047fdf9293c5feef4dc85ce58097ea1c6da4845a35153518374494e4459: 645575242n,
        },
    },
};
beforeEach(() => {
...
describe("builderMintPoolDatum()", () => {
    it("should build the pool mint datum properly", () => {
        const spiedOnComputePoolId = jest.spyOn(DatumBuilderLucidV3, "computePoolId");
        const spiedOnBuildLexicographicalAssetsDatum = jest.spyOn(DatumBuilderLucidV3.prototype, "buildLexicographicalAssetsDatum");
        const expectedIdent = "82f70fd1663b2b6f4250d6054fe4cac8c815d9eef8b38f68bbe22c92";
        const { inline } = builderInstance.buildMintPoolDatum(defaultArgs);
        expect(spiedOnComputePoolId).toHaveBeenNthCalledWith(1, defaultArgs.seedUtxo);
...
//# sourceMappingURL=buildMintPoolDatum.test.js.map