...
describe("buildPoolIdent", () => {
    it("should correctly build and validate a pool ident", () => {
        expect(() => builderInstance.buildPoolIdent(PREVIEW_DATA.pools.v1.ident)).toThrowError(DatumBuilderLucidV3.INVALID_POOL_IDENT);
        const validIdent = builderInstance.buildPoolIdent(PREVIEW_DATA.pools.v3.ident);
