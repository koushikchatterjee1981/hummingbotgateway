 ...
 */
export interface IComposedTx<Transaction = unknown, BuiltTransaction = unknown, Datum = string | undefined, Fees = Record<string, AssetAmount<IAssetAmountMetadata>>> {
    tx: Transaction;
    datum: Datum;
 ...
 */
export declare enum ETxBuilderType {
    LUCID = "lucid"
}
/**
 ...
 */
export declare enum EContractVersion {
    V1 = "V1",
    V3 = "V3"
}
/**
...
export interface IOrderRouteSwapArgs {
    ...
    swapB: Omit<ISwapConfigArgs, "suppliedAsset" | "orderAddresses" | "ownerAddress">;
}
//# sourceMappingURL=txbuilders.d.ts.map