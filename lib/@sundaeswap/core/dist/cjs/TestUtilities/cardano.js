...
exports.getBlockfrostProtocolParameters = exports.setupGlobalCardano = exports.windowCardano = void 0;
const globals_1 = require("@jest/globals");
const walletApiResponses = {
    balance: "821a89c8606ba1581cfa3eff2047fdf9293c5feef4dc85ce58097ea1c6da4845a351535183a14574494e44591a0584eba0",
    changeAddress: "00744b2df6faa2410bfe334e819db1f83689c08cb6fcf152298e1a14130d33957c07acdddecc9882457da22f05e0d189f7fc95b1972e6d5105",
    networkId: 0,
    rewardAddresses: [
...
const mockAPI = {
    experimental: {
        getCollateral: globals_1.jest
            .fn()
            .mockImplementation(() => Promise.resolve([walletApiResponses.utxos[0]])),
        off: globals_1.jest.fn(),
        on: globals_1.jest.fn(),
    },
    getBalance: globals_1.jest
        .fn()
        .mockImplementation(() => Promise.resolve(walletApiResponses.balance)),
    getChangeAddress: globals_1.jest
        .fn()
        .mockImplementation(() => Promise.resolve(walletApiResponses.changeAddress)),
    getNetworkId: globals_1.jest
        .fn()
        .mockImplementation(() => Promise.resolve(walletApiResponses.networkId)),
    getRewardAddresses: globals_1.jest
        .fn()
        .mockImplementation(() => Promise.resolve(walletApiResponses.rewardAddresses)),
    getCollateral: globals_1.jest
        .fn()
        .mockImplementation(() => Promise.resolve(walletApiResponses.collateral)),
    getUnusedAddresses: globals_1.jest
        .fn()
        .mockImplementation(() => Promise.resolve(walletApiResponses.unusedAddresses)),
    getUsedAddresses: globals_1.jest
        .fn()
        .mockImplementation(() => Promise.resolve(walletApiResponses.usedAddresses)),
    getUtxos: globals_1.jest
        .fn()
        .mockImplementation(() => Promise.resolve(walletApiResponses.utxos)),
    submitTx: globals_1.jest
        .fn()
        .mockImplementation(() => Promise.resolve("test-preview-txhash")),
    signData: globals_1.jest
        .fn()
        .mockImplementation(() => Promise.resolve({
        signature: "test-preview-signature",
        key: "test-preview-key",
    })),
    signTx: globals_1.jest
        .fn()
        .mockImplementation(() => Promise.resolve("test-preview-signedtx")),
};
exports.windowCardano = {
    eternl: {
        name: "Eternl",
        enable: globals_1.jest
            .fn()
            .mockImplementation(() => Promise.resolve(mockAPI)),
        icon: "",
        isEnabled: globals_1.jest
            .fn()
            .mockImplementation(() => Promise.resolve(true)),
        version: "test",
    },
};
const setupGlobalCardano = () => {
    Object.defineProperty(global, "window", {
        value: {
            cardano: exports.windowCardano,
        },
    });
};
exports.setupGlobalCardano = setupGlobalCardano;
const realBlockfrostProtocolParams = {
    epoch: 479,
    min_fee_a: 44,
    min_fee_b: 155381,
...
const getBlockfrostProtocolParameters = (env) => {
    switch (env) {
        default:
        case "preview":
            return {
                ...
                coinsPerUtxoByte: BigInt(realBlockfrostProtocolParams.coins_per_utxo_size),
                collateralPercentage: parseInt(realBlockfrostProtocolParams.collateral_percent),
                maxCollateralInputs: parseInt(realBlockfrostProtocolParams.max_collateral_inputs),
                costModels: realBlockfrostProtocolParams.cost_models,
            };
    }
};
exports.getBlockfrostProtocolParameters = getBlockfrostProtocolParameters;
