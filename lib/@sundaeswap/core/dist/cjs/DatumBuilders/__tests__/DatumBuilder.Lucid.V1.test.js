...
const DatumBuilder_Lucid_V1_class_js_1 = require("../DatumBuilder.Lucid.V1.class.js");
const DEFAULT_ORDER_ADDRESSES = {
    DestinationAddress: {
        datum: {
    ...
    AlternateAddress: "addr_test1qqpxt8wyqmsa28pxjk7z893txpy8608tn9d7kyaknpgfcmcjrlfzuz6h4ssxlm78v0utlgrhryvl2gvtgp53a6j9zngqllv3yr",
};
let builderInstance;
beforeEach(() => {
    builderInstance = new DatumBuilder_Lucid_V1_class_js_1.DatumBuilderLucidV1("preview");
});
afterEach(() => {
...
describe("DatumBuilderLucid.buildOrderAddressesDatum", () => {
    it("should pass when providing valid OrderAddresses arguments", () => {
        ...
        expect(result.inline).toStrictEqual("d8799fd8799fd8799fd8799f581cff310b072c281a4ef0e4166a00f9da571c4998cd57bb91764dfbdcf8ffd8799fd8799fd8799f581c0d33957c07acdddecc9882457da22f05e0d189f7fc95b1972e6d5105ffffffffd87a80ffd8799f581c121fd22e0b57ac206fefc763f8bfa0771919f5218b40691eea4514d0ffff");
        ...
        const { hash } = builderInstance.buildOrderAddresses(DEFAULT_ORDER_ADDRESSES);
        ...
        expect(result4.inline).toStrictEqual("");
    });
    ...
    it("should fail with non-serializable address strings", () => {
        try {
            ...
            expect(e.message).toStrictEqual("You supplied an invalid address: invalid. Please check your arguments and try again. Error message from LucidHelper: No address type matched for: invalid");
        }
        try {
            builderInstance.buildOrderAddresses({
    ...
    it("should correctly build and valid a pool ident", () => {
        expect(() => builderInstance.buildPoolIdent(mockData_js_1.PREVIEW_DATA.pools.v3.ident)).toThrowError(DatumBuilder_Lucid_V1_class_js_1.DatumBuilderLucidV1.INVALID_POOL_IDENT);
        const validIdent = builderInstance.buildPoolIdent(mockData_js_1.PREVIEW_DATA.pools.v1.ident);
        expect(validIdent).toEqual(mockData_js_1.PREVIEW_DATA.pools.v1.ident);
    });
...
//# sourceMappingURL=DatumBuilder.Lucid.V1.test.js.map