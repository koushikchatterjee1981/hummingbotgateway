...
const lucid_js_1 = require("../../exports/lucid.js");
const testing_js_1 = require("../../exports/testing.js");
const utilities_js_1 = require("../../exports/utilities.js");
const DatumBuilder_Lucid_V3_class_js_1 = require("../DatumBuilder.Lucid.V3.class.js");
let builderInstance;
const DEFAULT_DESTINATION_ADDRESS = testing_js_1.PREVIEW_DATA.addresses.alternatives[2];
beforeEach(() => {
...
describe("buildDestinationAddresses()", () => {
    it("should pass when providing a valid DestinationAddress argument", () => {
        ...
        const result2 = builderInstance.buildDestinationAddresses({
            ...
            address: "addr_test1vz5ykwgmrejk3mdw0u3cewqx375qkjwnv5n4mhgjwap4n4qrymjhv",
        });
        ...
        expect(result4.inline).toStrictEqual("d8799fd8799fd8799f581cff310b072c281a4ef0e4166a00f9da571c4998cd57bb91764dfbdcf8ffd8799fd8799fd8799f581c0d33957c07acdddecc9882457da22f05e0d189f7fc95b1972e6d5105ffffffffd87a9f5820a37a97d7c424ff00ff2c6413f9cc429e098623a73c440e8210cdb573a45fad5effff");
        ...
        expect(result5.inline).toEqual("");
    });
    it("should fail when an invalid DatumType is used", () => {
        expect(() => builderInstance.buildDestinationAddresses({
            datum: {
                // @ts-ignore
                type: "notvalid",
            },
            address: DEFAULT_DESTINATION_ADDRESS,
        })).toThrowError("Could not find a matching datum type for the destination address. Aborting.");
    });
    it("should fail when passing just a staking key as the DestinationAddress", () => {
        try {
            builderInstance.buildDestinationAddresses({
                address: "stake_test1uqxn89tuq7kdmhkvnzpy2ldz9uz7p5vf7l7ftvvh9ek4zpghgvr36",
                datum: {
                    type: index_js_1.EDatumType.NONE,
                },
            });
            ...
            expect(e.message).toStrictEqual("Invalid address. Make sure you are using a Bech32 or Hex encoded address that includes the payment key.");
        }
    });
    it("should fail with non-serializable address strings", () => {
        ...
        })).toThrowError("You supplied an invalid address: invalid. Please check your arguments and try again. Error message from LucidHelper: No address type matched for: invalid");
    });
    ...
    it("should fail when passing an invalid datumHash along with a script DestinationAddress", () => {
        ...
        try {
            ...
            expect(lucid_js_1.LucidHelper.throwInvalidOrderAddressesError).toHaveBeenCalledWith("addr_test1wpesulg5dtt5y73r4zzay9qmy3wnlrxdg944xg4rzuvewls7nrsf0", 'The datum provided was not a valid hex string. Original error: {"datum":{"type":"HASH","value":"invalidDatum"}}');
        }
    });
});
describe("buildOwnerDatum()", () => {
    it("should build the owner datum properly", () => {
        const spiedLucidHelperThrow = globals_1.jest.spyOn(lucid_js_1.LucidHelper, "throwInvalidOrderAddressesError");
        const spiedLucidHelperAddressHashes = globals_1.jest.spyOn(lucid_js_1.LucidHelper, "getAddressHashes");
...
describe("buildAssetDatum", () => {
    it("should correctly build the datum for ADA", () => {
        const result = builderInstance.buildAssetAmountDatum(new asset_1.AssetAmount(100n, utilities_js_1.ADA_METADATA));
...
describe("static addressSchemaToCredential", () => {
    it("should correctly convert address schemas to their Credentials", async () => {
        const lucidInstance = await lucid_cardano_1.Lucid.new(undefined, "Preview");
        ...
        expect(DatumBuilder_Lucid_V3_class_js_1.DatumBuilderLucidV3.addressSchemaToBech32(paymentAddress, lucidInstance)).toEqual("addr_test1vrp8nglm8d8x9w783c5g0qa4spzaft5z5xyx0kp495p8wkswmc787");
        const paymentAddressWithStakingKey = {
            paymentCredential: {
                VKeyCredential: {
                    bytes: "c279a3fb3b4e62bbc78e288783b58045d4ae82a18867d8352d02775a",
                },
        ...
        expect(DatumBuilder_Lucid_V3_class_js_1.DatumBuilderLucidV3.addressSchemaToBech32(paymentAddressWithStakingKey, lucidInstance)).toEqual("addr_test1qrp8nglm8d8x9w783c5g0qa4spzaft5z5xyx0kp495p8wksjrlfzuz6h4ssxlm78v0utlgrhryvl2gvtgp53a6j9zngqtjfk6s");
        const scriptAddress = {
            paymentCredential: {
                SCredential: {
        ...
        expect(DatumBuilder_Lucid_V3_class_js_1.DatumBuilderLucidV3.addressSchemaToBech32(scriptAddress, lucidInstance)).toEqual("addr_test1wr866xg5kkvarzll69xjh0tfvqvu9zvuhht2qve9ehmgp0qfgf3wc");
        const scriptAddressWithStakingKey = {
            paymentCredential: {
                SCredential: {
                    bytes: "cfad1914b599d18bffd14d2bbd696019c2899cbdd6a03325cdf680bc",
                },
        ...
        expect(DatumBuilder_Lucid_V3_class_js_1.DatumBuilderLucidV3.addressSchemaToBech32(scriptAddressWithStakingKey, lucidInstance)).toEqual("addr_test1zr866xg5kkvarzll69xjh0tfvqvu9zvuhht2qve9ehmgp0qjrlfzuz6h4ssxlm78v0utlgrhryvl2gvtgp53a6j9zngq4qar8t");
    });
});
//# sourceMappingURL=DatumBuilder.Lucid.V3.test.js.map