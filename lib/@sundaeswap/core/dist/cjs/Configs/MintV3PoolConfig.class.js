...
exports.MintV3PoolConfig = void 0;
const Config_abstract_class_js_1 = require("../Abstracts/Config.abstract.class.js");
class MintV3PoolConfig extends Config_abstract_class_js_1.Config {
    static MAX_FEE = 500n;
    assetA;
    assetB;
    fees;
...
exports.MintV3PoolConfig = MintV3PoolConfig;
